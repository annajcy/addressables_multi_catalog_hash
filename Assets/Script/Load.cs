...
namespace Script
{
    public class Load : MonoBehaviour
    {
        ...
        {
            var dlc1Handle =
                Addressables.LoadContentCatalogAsync("http://127.0.0.1:8085/StandaloneOSX/DLC1_0.1.0.json");
            ...
            var dlc2Handle = Addressables.LoadContentCatalogAsync("http://127.0.0.1:8085/StandaloneOSX/DLC2_0.1.0.json");
